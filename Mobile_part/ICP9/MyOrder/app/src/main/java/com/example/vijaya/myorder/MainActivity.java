...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        float totalPrice = calculatePrice(hasbellpeppers, hasonion, hascorn,hasolives);

        // create and store the order summary
        String orderSummaryMessage = createOrderSummary(userInputName, hasbellpeppers, hasonion, hascorn, hasolives, totalPrice);
    ...
    private String createOrderSummary(String userInputName,boolean hasbellpeppers, boolean hasonion,boolean hascorn,boolean hasolives, float price) {
        name = userInputName;
     ...
     * @return total Price
     */
    private float calculatePrice(boolean hasbellpeppers,boolean hasonion,boolean hascorn,boolean hasolives) {
